        ...
        <>
            ...
            {props.ds.cumRapChieu.map((detail, index) => {
                return <div className="d-flex ">
                    <div><img style={{ width: 50, height: 50 }} src={props.chiTietDetail.hinhAnh} /></div>
                    <div className="123 ms-2 ">
                        <a className="px-2" style={{ color: 'blue', fontWeight: "700" }} href={`#${detail.maCumRap}`} aria-expanded="false" data-toggle="collapse">{detail.tenCumRap}</a>
