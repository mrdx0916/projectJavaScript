    ...
    return (
        ...
        <div >
            ...
            <div className=" container  circles " >
                <div className="row  align-items-center circle1">
                    <div className="col-3 circle2">
                        <img style={{ width: "100%" }} src={props.chiTietDetail.hinhAnh} />
                    </div>
                    <div className="col-5 circle3 ">
                        <div>
                            <div className=" container  circleKhoiChieu " >{props.chiTietDetail?.ngayKhoiChieu}</div>
                            <div className=" container  circletenPhim " >{props.chiTietDetail?.tenPhim}</div>
                            <div>{props.chiTietDetail.heThongRapChieu ? props.chiTietDetail.heThongRapChieu[0].cumRapChieu[0].lichChieuPhim[0].thoiLuong : ""}</div>
                            <div>{props.chiTietDetail.moTa}</div>
                            <a href="#ChiTietPhimLichChieu03" className="pd-3 mt-3"><button className="btn btn-danger">Mua Vé</button></a>
                        </div>
                    </div>
                    <RenderDiemCircle danhGia={props.chiTietDetail.danhGia} />
                </div>
