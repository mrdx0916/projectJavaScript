...
export default function DangKy() {
    ...
    return (
        <div style={{ width: "100%", height: "100vh", opacity: 0.9, background: "url('https://www.elleman.vn/wp-content/uploads/2016/04/07/batmanvsuperman-elleman8.jpg')", backgroundSize: "cover", backgroundRepeat: 'no-repeat' }}>
            <div style={{ height: "100vh", opacity: 0.9 }} className="w-100 d-flex justify-content-center align-items-center" >
                <form
                    className="card w-50"
